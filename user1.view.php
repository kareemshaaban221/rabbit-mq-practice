...
<script>
    document.getElementById('form').addEventListener('submit', function(e) {
        ...
        // TODO API request to send message to the sender of user1
        if (input.value.trim()) {
            $.post('exchange.php', { message: input.value.trim(), username: 'user1' }, function(response) {
